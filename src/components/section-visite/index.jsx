    ...
    <div className="visite-service">
      <div className="bloc-text grey">
        ...
        <div className="bloc-img img">
          ...
          <p className="bloc-right-sup-para">
             Essayez de deviner quel animal vous
            entendez.
          </p>
        <div className="bloc-img ">
          <img
            src="https://www.palouma.fr/wp-content/uploads/2022/08/casque-audio-enfant-28.jpg" alt="casque-audio"
          />
        </div>
        </div>
        <div className="bloc-text grey">
        ...
        <div className="bloc-img img">
          <img
            src="https://img.freepik.com/premium-photo/young-talented-boy-artist-painter-kids-painting-with-paints-color-brush-park-outdoor_265223-43320.jpg" className="dessiner-animal"
            alt=""
          />
        </div>
        </div>
